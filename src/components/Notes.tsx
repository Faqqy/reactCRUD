  ...
  return (
    <>
        ...
        <div className="notes-container">
            {notes && notes.map((note) => {return <Note key={note.id} content={note.content} remove={removeNote} id={note.id}/>})}
        </div>
        <AddNote value={newNote} onChange={handleChange} createNote={createNote}/>
    </>   
  )
}
